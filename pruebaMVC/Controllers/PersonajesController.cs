...
namespace pruebaMVC.Controllers
{
    public class PersonajesController : Controller
    {
        ...
        public PersonajesController(PruebaMvcContext context)
        {
            _context = context;
        }
        ...
        {
            var pruebaMvcContext = _context.Personajes.Include(p => p.PerLib).Include(p => p.PerRol);
            return View(await pruebaMvcContext.ToListAsync());
        }
